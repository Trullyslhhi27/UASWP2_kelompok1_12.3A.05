...
<body>
  ...
  <section class="jumbotron" id="home">
    <main class="contain" data-aos="fade-right" data-aos-duration="1000">
      <h1 class="text-light">Sehatkan Dirimu Dengan Berolahraga di <span>Futsal</span> Zone </h1>
  ...
  <section class="pembayaran" id="bayar">
    ...
    <p class="text-center">Berikut adalah tata cara pembayaran lapangan pada website Futsal Zone:</p>
    <ul class="border list-group list-group-flush mt-5">
      <li class="list-group-item">1. Pengguna harus membuat akun atau mendaftar sebagai anggota pada website Futsal Zone.</li>
      ...
      <li class="list-group-item">5. Setelah status sudah di setujui, silahkan datang ke Futsal Zone sesuai jadwal yang di pesan</li>
    </ul>
  </section>
  <!-- End Pembayaran -->
  ...
  <section id="contact" class="contact" data-aos="fade-down" data-aos-duration="1000">
    ...
    <div class="row">
      <div class="col">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d337767.6030420949!2d106.96831483619819!3d-6.307882685591014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698671b82e87bf%3A0xe7318771148e5f8a!2sKab.%20Bekasi%2C%20Kec.%20Tambelang%2C%20Kabupaten%20Bekasi%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1701644076323!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <div class="col">
        <form action="">
