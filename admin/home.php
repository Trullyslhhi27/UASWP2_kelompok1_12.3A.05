      ...
      <div class="col-10 p-5 mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-3 justify-content-center my-5 gap-3">
          <div class="col">
            <div class="card align-items-center">
              <img src="../img/jumlah.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card align-items-center">
              <img src="../img/pesanan.jpg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card align-items-center">
              <img src="../img/member.jpg" class="card-img-top" alt="...">
              <div class="card-body">
        ...
        <div class="announcement">
          ...
          <div class="text p-2 mb-2">
            <p> Area No Smoking <br> <br> Kepada seluruh member Futsal Zone. <br>
              Kami ingin memberitahukan bahwa dilarang membuang sampah sembarangan Diharapkan membuang sampah
              pada tempatnya yang sudah disediakan Atas Perhatiannya Terima Kasih. <br> <br>
              Salam Olahraga <br>
              Futsal Zone
            </p>
          </div>
